...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route, HttpServletRequest request, HttpServletResponse response)
        ...
        Map<String, Object> view = (Map<String,Object>) request.getSession().getAttribute("view");
        if (view == null) {
            view = new HashMap<>();
        ...
        try {
            ...
            for (int i = 0; i < parameters.length; i++) {
                parameters[i] = parameterTypes[i] == Map.class ? view : request;
            }
    ...
    private Template newTemplate(String templateName) throws ServletException {
        ...
        for (Configuration configuration : new Configuration[]{sourceConfiguration, targetConfiguration}) {
